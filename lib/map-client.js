  ...
  init() {
    ...
    return ConfigLoader(this._options.mapConfigHost, this._options.mapConfigURL)
      .then((mapConfig) => {
        ...
        // const getFeatureComponent = new GetFeatureInfoComponent(this._olMap, overlayLayersRenderManager, this._$target);
        const getFeatureComponent = new GetFeatureInfoComponent(this);
