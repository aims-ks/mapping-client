  ...
  init() {
    ...
    return ConfigLoader(this._options.mapConfigHost, this._options.mapConfigURL)
      .then((mapConfig) => {
        ...
        this._componentsBuilder = new ComponentsBuilder(mapConfig, this._layerModelsLoader, this._olMap);
        this._componentsBuilder.build({
          ...
          'featureRequestsDirectClick': this._options.featureRequestsDirectClick,
          'featureRequestsResultsPosition': this._options.featureRequestsResultsPosition,
        }, this._$target.find('.ol-overlaycontainer-stopevent'));
