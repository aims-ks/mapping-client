...
const olDragBoxInteraction = (global.ol ? global.ol.interaction.DragBox: require('ol/interaction/dragbox'));
const olEventsConditions = (global.ol ? global.ol.events.condition : require('ol/events/condition'));
const olSelectInteraction = (global.ol ? global.ol.interaction.Select : require('ol/interaction/select'));
