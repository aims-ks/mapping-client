const SymbologyFilterEvaluator = require('./symbology-filter-evaluator');
 ...
 */
module.exports = class AbstractDynamicLayerStyleSelector {
  ...
  identifyStyle(dataRecord) {
    ...
    const cachedItem = _internalCache.find(function(_cachedItem) {
      const isTrue = SymbologyFilterEvaluator.evaluate(
        _cachedItem.filter,
