...
const olFeature = (global.ol ? global.ol.Feature : require('ol/feature'));
const olPointGeom = (global.ol ? global.ol.geom.Point : require('ol/geom/point'));
const olVectorLayer = (global.ol ? global.ol.layer.Vector : require('ol/layer/vector'));
const olVectorSource = (global.ol ? global.ol.source.Vector : require('ol/source/vector'));
