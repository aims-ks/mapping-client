...
const ActiveLayersModelBuilder = require('./active-layers-model-builder');
const AvailableLayersModelBuilder = require('./available-layers-model-builder');
const SimpleLayerModel = require('./simple-layer-model');
const SimpleLayerModelFactory = require('./simple-layer-model-factory');
const SingleLayerModelFactory = require('./single-layer-model-factory');

module.exports = class LayerModelsLoader {
  ...
  constructor(mapConfig) {
    ...
    this._availableBaseLayersModel = AvailableLayersModelBuilder.make(
    ...
    this._activeBaseLayersModel = ActiveLayersModelBuilder.make(
    ...
    this._availableOverlayLayersModel = AvailableLayersModelBuilder.make(
      mapConfig.defaultLayers,
      function (defaultLayer) {
        return !defaultLayer.isBaseLayer;
      },
    ...
    this._activeOverlayLayersModel = ActiveLayersModelBuilder.make(
