/**
 * A specialised helper class for providing the MapDataLayerView with the appropriate style to use
 * when rendering a point. This class is expected to abstract all decisions away from the
 * MapDataLayerView. Extending classes must populate the {@link #_stylesCache} for use by
