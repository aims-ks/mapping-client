...
export default class ComponentsBuilder {
  ...
  _buildShowLayersComponent($target) {
    ...
    this._userInterfaceComponent.getRightControlsPanel().addButton(
      ...
      function() {
        self._userInterfaceComponent.getRightSideBar().showPanel(
          'Legend',
          self._showLayersDialogActionButtons,
  ...
  _buildLegendComponent($target) {
    ...
    this._userInterfaceComponent.getRightControlsPanel().addButton(
      ...
      'toc',
      function(){
        self._userInterfaceComponent.getRightSideBar().showPanel('Legend', [], self._legend.render());
      }
    );
  }
