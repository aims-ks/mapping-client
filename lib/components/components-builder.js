...
export default class ComponentsBuilder {
  ...
  _buildShowLayersComponent() {
    ...
    const showLayersControlButton = new ControlButton(
    ...
    this._userInterfaceComponent.getRightControlsPanel().addButton(showLayersControlButton);
  ...
  _buildLegendComponent() {
    ...
    const legendControlButton = new ControlButton(
    ...
    this._userInterfaceComponent.getRightControlsPanel().addButton(legendControlButton);
