...
export default class ComponentsBuilder {
  ...
  build(options, $target) {
    ...
    if (!options.disableShowLayers) {
      ...
      this._buildShowLayersComponent(options.defaultActiveComponent === 'showLayers');
    }

    if (!options.disableLegend) {
      this._buildLegendComponent(options.defaultActiveComponent === 'legend');
    }

    if (!options.disableFeatureRequests) {
      this._buildGetFeatureInfoComponent(options, options.defaultActiveComponent === 'getFeatureInfo');
    }
