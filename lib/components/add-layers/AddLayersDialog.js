 ...
 */
import AddLayersTab from './AddLayersTab';

const $ = (global.$ || global.jQuery ? global.$ || global.jQuery : require('jquery'));
require('bootstrap');

const NAME = 'mapping-client-add-layer-modal';
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <ul class="nav nav-pills" role="tablist">
                    <li role="presentation" class="nav-item"><a class="nav-link active" href="#${BASE_LAYERS_PANEL_NAME}" role="tab" data-toggle="tab">Base Layers</a></li>
                    <li role="presentation" class="nav-item"><a class="nav-link" href="#${OVERLAY_LAYERS_PANEL_NAME}" role="tab" data-toggle="tab">Overlay Layers</a></li>
                </ul>
