    ...
    if (!_$targetEl.hasClass('download-success') && !_$targetEl.hasClass('download-failed')) {
      ...
      $.ajax({
        ...
        if (cachedLayer) {
          ...
          if (cachedLayer.hasOwnProperty('options') && !supportedLayer.hasOwnProperty('time')) {
