...
<div class="${NAME}">
    <div class="form-group row">
        <label for="aims-map-layer-opacity-${NAME}" class="col-sm-3 col-form-label">Opacity</label>
        <div class="col-sm-9">
            <input type="range" min="0" max="1" step="0.05" value="1" class="aims-map-layer-opacity form-control" id="aims-map-layer-opacity-${NAME}">
        </div>    
    </div>
</div>
`;
