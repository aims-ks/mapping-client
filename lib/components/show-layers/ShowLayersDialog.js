import AvailableBaseLayersListView from './AvailableBaseLayersListView';
import AvailableLayersChangeHandler from './AvailableLayersChangeHandler';
import AvailableOverlayLayersListView from './AvailableOverlayLayersListView';
...
export default class ShowLayersDialog {
  ...
  constructor(
    ...
    availableBaseLayersListView.init();

    const activeBaseLayersChangeHandler = new AvailableLayersChangeHandler(
      activeBaseLayersModel,
      availableBaseLayersModel,
    ...
    activeBaseLayersChangeHandler.init();
    ...
    availableOverlayLayersListView.init();
    ...
    availableLayersChangeHandler.init();
