...
export default class ShowLayersDialog {
   ...
   */
  constructor(availableBaseLayersModel, activeBaseLayersModel, availableOverlayLayersModel,
    ...
    const _$baseLayersList = this._$el.find('.base-layers-list');
    ...
    const _$overlayLayersList = this._$el.find('.overlay-layers-list');
