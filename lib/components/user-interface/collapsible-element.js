...
export default class CollapsibleElement {
  ...
  constructor(layer) {
    ...
    this._keepState = false; // only keep state (open/closed) when user actively clicked the collapse button

    this._$containerEl = $('<div class="aims-map-collapsible-element-container"></div>');
    this._$collapseButtonEl = $(`<button type="button" class="btn btn-link aims-map-collapsible-element-collapse-button" title="Open"><i class="material-icons">keyboard_arrow_down</i>${layer.title}</button>`);

    this._$headerEl = $('<div class="aims-map-collapsible-element-title"></div>');
    this._$headerEl.append(this._$collapseButtonEl);

    this._$contentEl = $('<div class="aims-map-collapsible-element-content loading"></div>');
  ...
  show() {
    ...
    this._$containerEl.addClass('aims-map-collapsible-element-content-open');
  ...
  hide() {
    ...
    this._$containerEl.removeClass('aims-map-collapsible-element-content-open');
