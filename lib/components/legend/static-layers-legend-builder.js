const AbstractLegendBuilder = require('./abstract-legend-builder');

/**
 * Component responsible for rendering a legend of static layers.
 */
module.exports = class StaticLayersLegendBuilder extends AbstractLegendBuilder {
  ...
  buildHtml() {
    ...
    this._activeLayersModel.getLayers().forEach((_layer) => {
      ...
      if (dataSource && dataSource.showInLegend && dataSource.legendUrl) {
