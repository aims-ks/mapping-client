...
export default class LegendComponent {
   ...
   * DOM.
   *
   * @param $root {JQueryObject} A JQuery object representing the root element into which this
   * component should insert itself.
   */
  constructor($root) {
    let that = this;
    this._$parent = $root.find('.ol-viewport .ol-overlaycontainer-stopevent');
    ...
    this._$legendEl.append('<div class="controls ol-control ol-unselectable"><button type="button" class="close-legend"><i class="material-icons">clear</i></button></div>');
    ...
    this._$parent.append('<div class="aims-map-legend-icon ol-control ol-unselectable" style="display: none;"><button type="button"><i class="material-icons">toc</i></button></div>');
