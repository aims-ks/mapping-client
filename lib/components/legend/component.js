...
export default class LegendComponent {
  ...
  constructor($parent) {
    ...
    this._$legendEl.append('<div class="controls ol-control"><button type="button" class="close-legend"><i class="material-icons md-18">clear</i></button></div>');
    ...
    this._$parent.append('<div class="aims-map-legend-icon ol-control" style="display: none;"><button type="button"><i class="material-icons md-18">toc</i></button></div>');
